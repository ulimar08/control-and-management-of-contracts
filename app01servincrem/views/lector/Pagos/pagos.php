...
<br><br>
  ...
  <button class="btn btn-success btn-md" onclick="mostrarTabla()">Mostrar Historial</button>
  <button class="btn btn-success btn-md" onclick="ocultarTabla()">Ocultar Historial</button>
  </div>
